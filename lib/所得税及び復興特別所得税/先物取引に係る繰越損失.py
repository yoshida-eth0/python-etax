...
class 申告書への記載事項:
    ...
    def x1が黒字の場合_先物取引に係る雑所得等の金額(self) -> int:
        ...
        14. 先物取引に係る雑所得等の金額
        """
        if 0<=self.先物取引に係る雑所得等の金額.本年分の先物取引に係る雑所得等の金額:
    ...
    def x1が赤字の場合_翌年以後に繰り越される先物取引に係る損失の金額(self) -> int:
        ...
        """
        if self.先物取引に係る雑所得等の金額.本年分の先物取引に係る雑所得等の金額<0:
            return sum([
                self.翌年以後に繰り越される先物取引に係る損失の計算.x2年前.翌年分以後に繰り越して差し引かれる先物取引の差金等決済に係る所得の損失の額,
                self.翌年以後に繰り越される先物取引に係る損失の計算.x前年.翌年分以後に繰り越して差し引かれる先物取引の差金等決済に係る所得の損失の額,
...
class 先物取引に係る繰越損失:
    ...
    """
    def __init__(self,
                 x先物取引に係る雑所得等の金額の計算明細書: 先物取引に係る雑所得等の金額の計算明細書,
        ...
        # 1. 先物取引に係る雑所得等の金額
        self.先物取引に係る雑所得等の金額 = 先物取引に係る雑所得等の金額(x先物取引に係る雑所得等の金額の計算明細書)
