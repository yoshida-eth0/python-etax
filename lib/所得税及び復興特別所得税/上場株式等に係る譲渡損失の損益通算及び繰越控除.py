...
class 本年分の損益通算前の分離課税配当所得等金額:
    ...
    def to_dataframe(self) -> pd.DataFrame:
        ...
        """
        return pd.DataFrame([
            ['4', '本年分の損益通算前の分離課税配当所得等金額', self.本年分の損益通算前の分離課税配当所得等金額],
        ], columns=['key', 'label1', 'value'])
...
class 本年分の上場株式等に係る譲渡損失の金額及び分離課税配当所得等金額の計算:
    """
    所得税及び復興特別所得税の確定申告書付表
    上場株式等に係る譲渡損失の損益通算及び繰越控除用
    1. 本年分の上場株式等に係る譲渡損失の金額及び分離課税配当所得等金額の計算
    ...
    def __init__(self, x本年分の損益通算前の上場株式等に係る譲渡損失の金額: 本年分の損益通算前の上場株式等に係る譲渡損失の金額, x本年分の損益通算前の分離課税配当所得等金額: 本年分の損益通算前の分離課税配当所得等金額):
        ...
        self.本年分の損益通算後の上場株式等に係る譲渡損失の金額又は分離課税配当所得等金額 = 本年分の損益通算後の上場株式等に係る譲渡損失の金額又は分離課税配当所得等金額(
            x本年分の損益通算前の上場株式等に係る譲渡損失の金額=x本年分の損益通算前の上場株式等に係る譲渡損失の金額,
            x本年分の損益通算前の分離課税配当所得等金額=x本年分の損益通算前の分離課税配当所得等金額
        )
    ...
    def to_dataframe(self) -> pd.DataFrame:
        ...
        """
        dfs = [
            self.本年分の損益通算前の上場株式等に係る譲渡損失の金額.to_dataframe(),
            self.本年分の損益通算前の分離課税配当所得等金額.to_dataframe(),
...
class 翌年以降に繰り越される上場株式等に係る譲渡損失の金額の計算_年分:
    ...
    1年分
    """
    def __init__(self, 年分: str, is_繰越対象: bool, x株式等に係る譲渡所得等の金額の計算明細書: 株式等に係る譲渡所得等の金額の計算明細書, x本年分の上場株式等に係る譲渡損失の金額及び分離課税配当所得等金額の計算: 本年分の上場株式等に係る譲渡損失の金額及び分離課税配当所得等金額の計算, 過去の年分一覧: list[Self], 前年から繰り越された上場株式等に係る譲渡損失の金額: int = 0):
        self.年分 = 年分
        self.is_繰越対象 = is_繰越対象
        self.株式等に係る譲渡所得等の金額の計算明細書 = x株式等に係る譲渡所得等の金額の計算明細書
        self.本年分の上場株式等に係る譲渡損失の金額及び分離課税配当所得等金額の計算 = x本年分の上場株式等に係る譲渡損失の金額及び分離課税配当所得等金額の計算
    ...
    def _分離課税配当所得等金額の残高(self) -> int:
        ...
        分離課税配当所得等金額の残高
        """
        _max = self.本年分の上場株式等に係る譲渡損失の金額及び分離課税配当所得等金額の計算.本年分の損益通算後の上場株式等に係る譲渡損失の金額又は分離課税配当所得等金額.本年分の損益通算後の分離課税配当所得等金額
...
class 翌年以降に繰り越される上場株式等に係る譲渡損失の金額の計算:
    ...
    2. 翌年以降に繰り越される上場株式等に係る譲渡損失の金額の計算
    """
    def __init__(self, x株式等に係る譲渡所得等の金額の計算明細書: 株式等に係る譲渡所得等の金額の計算明細書, x本年分の上場株式等に係る譲渡損失の金額及び分離課税配当所得等金額の計算: 本年分の上場株式等に係る譲渡損失の金額及び分離課税配当所得等金額の計算, x3年前から繰り越された上場株式等に係る譲渡損失の金額: int = 0, x2年前から繰り越された上場株式等に係る譲渡損失の金額: int = 0, x前年から繰り越された上場株式等に係る譲渡損失の金額: int = 0):
        self.株式等に係る譲渡所得等の金額の計算明細書 = x株式等に係る譲渡所得等の金額の計算明細書
        self.本年分の上場株式等に係る譲渡損失の金額及び分離課税配当所得等金額の計算 = x本年分の上場株式等に係る譲渡損失の金額及び分離課税配当所得等金額の計算

        self.本年の3年前分 = 翌年以降に繰り越される上場株式等に係る譲渡損失の金額の計算_年分(
            '3年前', False, x株式等に係る譲渡所得等の金額の計算明細書, x本年分の上場株式等に係る譲渡損失の金額及び分離課税配当所得等金額の計算,
            [],
            x3年前から繰り越された上場株式等に係る譲渡損失の金額
        )
        self.本年の2年前分 = 翌年以降に繰り越される上場株式等に係る譲渡損失の金額の計算_年分(
            '2年前', True, x株式等に係る譲渡所得等の金額の計算明細書, x本年分の上場株式等に係る譲渡損失の金額及び分離課税配当所得等金額の計算,
            [self.本年の3年前分],
            x2年前から繰り越された上場株式等に係る譲渡損失の金額
        )
        self.本年の前年分 = 翌年以降に繰り越される上場株式等に係る譲渡損失の金額の計算_年分(
            '前年', True, x株式等に係る譲渡所得等の金額の計算明細書, x本年分の上場株式等に係る譲渡損失の金額及び分離課税配当所得等金額の計算,
    ...
    def 翌年以後に繰り越される上場株式等に係る譲渡損失の金額(self) -> int:
        ...
        """
        total = 0
        total += self.本年分の上場株式等に係る譲渡損失の金額及び分離課税配当所得等金額の計算.本年分の損益通算後の上場株式等に係る譲渡損失の金額又は分離課税配当所得等金額.本年分の損益通算後の上場株式等に係る譲渡損失の金額
...
class 前年から繰り越された上場株式等に係る譲渡損失の金額を控除した後の本年分の分離課税配当所得等金額の計算:
    ...
    3. 前年から繰り越された上場株式等に係る譲渡損失の金額を控除した後の本年分の分離課税配当所得等金額の計算
    """
    def __init__(self, x本年分の上場株式等に係る譲渡損失の金額及び分離課税配当所得等金額の計算: 本年分の上場株式等に係る譲渡損失の金額及び分離課税配当所得等金額の計算, x翌年以降に繰り越される上場株式等に係る譲渡損失の金額の計算: 翌年以降に繰り越される上場株式等に係る譲渡損失の金額の計算):
        self.本年分の上場株式等に係る譲渡損失の金額及び分離課税配当所得等金額の計算 = x本年分の上場株式等に係る譲渡損失の金額及び分離課税配当所得等金額の計算
    ...
    def 前年から繰り越された上場株式等に係る譲渡損失の金額を控除した後の本年分の分離課税配当所得等金額の計算(self) -> int:
        ...
        """
        return self.本年分の上場株式等に係る譲渡損失の金額及び分離課税配当所得等金額の計算.本年分の損益通算後の上場株式等に係る譲渡損失の金額又は分離課税配当所得等金額.本年分の損益通算後の分離課税配当所得等金額 - self.翌年以降に繰り越される上場株式等に係る譲渡損失の金額の計算.本年分で分離課税配当所得等金額から差し引く上場株式等に係る譲渡損失の金額の合計額
...
class 上場株式等に係る譲渡損失の損益通算及び繰越控除:
    ...
    def __init__(self,
                 ...
                 x本年分の損益通算前の分離課税配当所得等金額: 本年分の損益通算前の分離課税配当所得等金額|None = None,
        ...
        x本年分の損益通算前の分離課税配当所得等金額 = x本年分の損益通算前の分離課税配当所得等金額 or 本年分の損益通算前の分離課税配当所得等金額()

        # 1. 本年分の上場株式等に係る譲渡損失の金額及び分離課税配当所得等金額の計算
        self.本年分の上場株式等に係る譲渡損失の金額及び分離課税配当所得等金額の計算 = 本年分の上場株式等に係る譲渡損失の金額及び分離課税配当所得等金額の計算(
        ...
        self.翌年以降に繰り越される上場株式等に係る譲渡損失の金額の計算 = 翌年以降に繰り越される上場株式等に係る譲渡損失の金額の計算(
            x株式等に係る譲渡所得等の金額の計算明細書=x株式等に係る譲渡所得等の金額の計算明細書,
            x本年分の上場株式等に係る譲渡損失の金額及び分離課税配当所得等金額の計算=self.本年分の上場株式等に係る譲渡損失の金額及び分離課税配当所得等金額の計算,
        ...
        self.前年から繰り越された上場株式等に係る譲渡損失の金額を控除した後の本年分の分離課税配当所得等金額の計算 = 前年から繰り越された上場株式等に係る譲渡損失の金額を控除した後の本年分の分離課税配当所得等金額の計算(
            self.本年分の上場株式等に係る譲渡損失の金額及び分離課税配当所得等金額の計算,
    ...
    def to_dataframe(self) -> pd.DataFrame:
        ...
        """
        dfs = [
            self.本年分の上場株式等に係る譲渡損失の金額及び分離課税配当所得等金額の計算.to_dataframe(),
